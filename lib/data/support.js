...
`;
  ...
  async function act(fn, { pending, done } = {}) {
    ...
    try { const r = await fn(); if (done) toast(done, "ok"); return r; }
  ...
  window.RevnuSupport = { createTicket, updateTicket, addReply, list: load, defineTour, startTour, firstRun, openTicketModal, SupportButtons, pickFile, uploadFor, openDocument, toast, fail, busy, act };
